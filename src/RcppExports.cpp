...
BEGIN_RCPP
    ...
    read_chunked_long(filename, callback, chunksize, var_names, var_types, rt_info_, var_pos_info_, var_opts_, isGzipped, progress);
    return R_NilValue;
END_RCPP
}
// read_long
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type isGzipped(isGzippedSEXP);
    Rcpp::traits::input_parameter< bool >::type progress(progressSEXP);
    rcpp_result_gen = Rcpp::wrap(read_long(filename, var_names, var_types, rt_info_, var_pos_info_, var_opts_, isGzipped, progress));
