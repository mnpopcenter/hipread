...
agree to abide by the [code of conduct](https://github.com/mnpopcenter/hipread/blob/master/CONDUCT.md).

# Issues (Reporting a problem or suggestion)
If you've experience a problem with the package, or have a suggestion for it, 
please post it on the [issues tab](https://github.com/mnpopcenter/hipread/issues).
